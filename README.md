...
generalization of the deep learning-based object detectors. You can read the paper at [Multi-domain autonomous driving dataset: Towards enhancing the generalization of the convolutional neural networks in new environments](https://ietresearch.onlinelibrary.wiley.com/doi/full/10.1049/ipr2.12710)
